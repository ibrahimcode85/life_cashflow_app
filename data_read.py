...
def read_pricing_model_data(file_path):
    ...
    expense_per_contribution_per_year = wb.defined_names[
        "Expense_perContribution_perYear"
    ].value
    ...
    contribution_per_year_value = get_named_range_value(
        model_point_ws, contribution_per_year
    )
    surplus_share_to_shf_value = get_named_range_value(
        model_point_ws, surplus_share_to_shf
    )
    surplus_share_to_participant_value = get_named_range_value(
        model_point_ws, surplus_share_to_participant
    )
    #   from the 'Table' tab
    ...
    expense_per_contribution_per_year_value = get_named_range_value(
        tables_ws, expense_per_contribution_per_year
    )
    expense_per_fund_per_year_value = get_named_range_value(
        tables_ws, expense_per_fund_per_year
    )
